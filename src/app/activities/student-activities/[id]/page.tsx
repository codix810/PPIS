...
export default function StuActivDetail({ params }: PageProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 font-sans" style={{ fontFamily: "'Poppins', sans-serif" }}>
      <h1 className="text-4xl font-bold mb-14 text-start" style={{ color:"#ef1717ff" }}>|Student Activities</h1>
      ...
      <h1 className="text-4xl font-bold mb-4 text-gray-900">{stuActivItem.title}</h1>
