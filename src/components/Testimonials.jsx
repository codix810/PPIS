    ...
    <section className="py-16 px-8 bg-gradient-to-tr from-red-950 via-black to-blue-950 text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {subjects.map((subject, index) => (
          <div
            key={index}
            className=" text-white rounded-lg shadow-2xl bg-gradient-to-tl from-white/20 via-black to-white/50 p-6 flex flex-col items-center text-center hover:shadow-2xl  hover:scale-105 transition-transform duration-300"
          >
            {subject.icon}
