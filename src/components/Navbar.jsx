        ...
        <>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              ...
              <div className="hidden min-[970px]:flex flex-wrap gap-3 justify-center flex-1">
              ...
              <div className="flex min-[970px]:hidden">
          ...
          {/* Mobile Panel */}
          <DisclosurePanel className="min-[970px]:hidden bg-[#0B1A33]">
