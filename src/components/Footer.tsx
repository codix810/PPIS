    ...
    >
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+201030171518" className="text-gray-300 hover:text-red-500">
                +201030171518
              </a>
            </li>
            <li className="flex items-center gap-3">
              <FaEnvelope className="text-lg text-gray-400" />
              <a href="mailto:ppis@aun.edu.eg" className="text-gray-300 hover:text-red-500">
                ppis@aun.edu.eg
              </a>
            </li>
            <li className="flex items-center gap-3">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between mt-8 gap-6">
        <div className="flex items-center space-x-4">
          ...
          <img src="/ppis.jpg" alt="PPIS Logo" className="w-14 h-14 rounded-full object-cover" />
        </div>
      </div>
